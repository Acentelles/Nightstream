...
#[test]
#[ignore = "uniform kernel defers virtual-row pc gating to Route-A time-domain semantics"]
...
#[test]
#[ignore = "uniform kernel defers virtual sequence countdown checks to Route-A time-domain semantics"]
...
#[test]
#[ignore = "uniform kernel defers virtual commit linkage checks to Route-A time-domain semantics"]
...
#[test]
#[ignore = "uniform kernel defers rd write-lane quiescence checks to Route-A time-domain semantics"]
