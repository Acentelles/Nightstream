...
use deprecated_neo_memory::mle::build_chi_table;
use deprecated_neo_memory::output_check::{
...
fn test_repro_num_bits_32_fails_in_output_sumcheck_generation() {
    ...
    let err = deprecated_neo_memory::output_check::generate_output_sumcheck_proof_and_challenges(
        &mut tr,
        32,
        program_io,
        &final_memory_state,
...
fn test_output_point_check_supports_32_bit_addresses() {
    ...
    let state = deprecated_neo_memory::output_check::sample_output_point_state(&mut tr, 32, program_io)
...
fn output_sumcheck_accepts_correct_claims() {
    use deprecated_neo_memory::output_check::generate_output_sumcheck_proof_and_challenges;
