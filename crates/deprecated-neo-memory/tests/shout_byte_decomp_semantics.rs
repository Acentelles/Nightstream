...
//! runs `deprecated_neo_memory::shout::check_shout_semantics` to get precise, step-indexed failures (instead
...
use deprecated_neo_memory::shout::check_shout_semantics;
use deprecated_neo_memory::sparse_time::SparseIdxVec;
use deprecated_neo_memory::twist_oracle::AddressLookupOracle;
use deprecated_neo_memory::witness::{LutInstance, LutWitness};
