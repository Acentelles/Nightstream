...
use deprecated_neo_memory::riscv::elf_loader::load_elf;
...
use deprecated_neo_memory::riscv::lookups::{encode_program, RiscvInstruction, RiscvMemOp, RiscvOpcode};
use deprecated_neo_memory::riscv::trace::{Rv64TraceLayout, Rv64TraceWitness};
...
use deprecated_neo_vm_trace::{trace_program, Twist, VmCpu};
...
fn rv64_note_lowering_accepts_supported_program_and_rejects_atomics_profile() {
    ...
    assert!(matches!(
        ...
        deprecated_neo_memory::LoweredInstruction::Passthrough(RiscvInstruction::IAluw {
            op: RiscvOpcode::Addw,
            ..
        })
    ));
    ...
    let atomics_profile = RiscvProofProfile::new(RiscvProofProfileConfig {
        ...
        memory_layout_kind: deprecated_neo_memory::ProofAddressRemapKind::SegmentedWordAddress,
