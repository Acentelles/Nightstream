...
use deprecated_neo_memory::cpu::bus_layout::build_bus_layout_for_instances_with_shout_and_twist_lanes;
use deprecated_neo_memory::cpu::constraints::{ShoutCpuBinding, TwistCpuBinding};
use deprecated_neo_memory::plain::{LutTable, PlainMemLayout};
use deprecated_neo_memory::{CpuArithmetization, R1csCpu, SharedCpuBusConfig};
use deprecated_neo_vm_trace::{ShoutEvent, ShoutId, StepTrace, VmTrace};
...
fn with_shared_cpu_bus_injects_constraints_and_forces_const_one() {
    ...
    let cpu = R1csCpu::new(
        ...
        &tables,
        &HashMap::new(),
        Box::new(|_step: &[deprecated_neo_vm_trace::StepTrace<u64, u64, u128>]| vec![F::ZERO]),
    )
    .expect("R1csCpu::new");
