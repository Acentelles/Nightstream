...
use deprecated_neo_memory::builder::{build_shard_witness_shared_cpu_bus, CpuArithmetization};
...
impl CpuArithmetization<Goldilocks, (), u128> for DummyCpuArith {
    ...
    fn build_ccs_chunks(
        &self,
        trace: &deprecated_neo_vm_trace::VmTrace<u64, u64, u128>,
        chunk_size: usize,
...
fn build_shard_witness_shared_cpu_bus_sets_init_policy_per_step() {
    ...
    let lut_tables: HashMap<u32, deprecated_neo_memory::plain::LutTable<Goldilocks>> = HashMap::new();
    let lut_table_specs: HashMap<u32, deprecated_neo_memory::witness::LutTableSpec> = HashMap::new();
