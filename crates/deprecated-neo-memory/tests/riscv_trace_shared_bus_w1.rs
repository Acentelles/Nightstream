...
use deprecated_neo_memory::cpu::CPU_BUS_COL_DISABLED;
...
use deprecated_neo_memory::riscv::instruction::operand_mode_keys_enabled;
use deprecated_neo_memory::riscv::lookups::{RiscvOpcode, RiscvShoutTables, PROG_ID, RAM_ID, REG_ID};
