use deprecated_neo_vm_trace::{Shout, Twist};
...
impl RiscvCpu {
    ...
    fn finalize_decomposition_step(
        ...
        next_pc: u64,
    ) -> Result<deprecated_neo_vm_trace::StepMeta<u64>, String> {
        ...
        Ok(deprecated_neo_vm_trace::StepMeta {
            pc_after: self.pc,
            opcode,
            is_virtual,
    ...
    ) -> Result<Option<deprecated_neo_vm_trace::StepMeta<u64>>, String>
    where
        T: Twist<u64, u64>,
        S: Shout<u128, u64>,
    {
...
impl deprecated_neo_vm_trace::VmCpu<u64, u64, u128> for RiscvCpu {
    type Error = String;
    ...
    fn step<T, S>(
        ...
        twist: &mut T,
        shout: &mut S,
    ) -> Result<deprecated_neo_vm_trace::StepMeta<u64>, Self::Error>
    where
        T: Twist<u64, u64>,
        S: Shout<u128, u64>,
    {
