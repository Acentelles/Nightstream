//! Core shard verification logic.
//!
//! This module owns the protocol-facing verification path for shard proofs.
//! Public API shaping and compatibility wrappers live in `verify_api.rs`.
        ...
        let crate::memory_sidecar::route_a_time::RouteABatchedTimeVerifyOutput {
            ...
            crate::memory_sidecar::route_a_time::RouteABatchedTimeVerifyConfig {
                ...
                output_binding: crate::memory_sidecar::route_a_time::OutputBindingTimeVerifyConfig {
                    ...
                    inc_total_degree_bound: ob_inc_total_degree_bound,
                },
            },
        )?;
