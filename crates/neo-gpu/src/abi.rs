...
#[cfg(not(target_arch = "wasm32"))]
pub const RQ_MUL_BATCH_PREPARE_SYMBOL: &[u8] = b"nightstream_gpu_rq_mul_batch_prepare_u64x54\0";
#[cfg(not(target_arch = "wasm32"))]
pub const RQ_ACCUMULATE_BATCH_PREPARE_SYMBOL: &[u8] = b"nightstream_gpu_rq_accumulate_batch_prepare_u64x54\0";
#[cfg(not(target_arch = "wasm32"))]
pub const RQ_PREPARED_EXECUTE_SYMBOL: &[u8] = b"nightstream_gpu_rq_prepared_execute\0";
#[cfg(not(target_arch = "wasm32"))]
pub const RQ_PREPARED_READ_SYMBOL: &[u8] = b"nightstream_gpu_rq_prepared_read_u64x54\0";
#[cfg(not(target_arch = "wasm32"))]
pub const RQ_PREPARED_DESTROY_SYMBOL: &[u8] = b"nightstream_gpu_rq_prepared_destroy\0";
#[cfg(not(target_arch = "wasm32"))]
...
#[cfg(not(target_arch = "wasm32"))]
pub const SUPERNEO_ROW_DOT_PREPARE_SYMBOL: &[u8] = b"nightstream_gpu_superneo_row_dot_prepare\0";
#[cfg(not(target_arch = "wasm32"))]
pub const SUPERNEO_ROW_DOT_DUAL_PREPARE_SYMBOL: &[u8] = b"nightstream_gpu_superneo_row_dot_dual_prepare\0";
#[cfg(not(target_arch = "wasm32"))]
pub const SUPERNEO_PREPARED_EXECUTE_SYMBOL: &[u8] = b"nightstream_gpu_superneo_prepared_execute\0";
#[cfg(not(target_arch = "wasm32"))]
pub const SUPERNEO_PREPARED_READ_SYMBOL: &[u8] = b"nightstream_gpu_superneo_prepared_read\0";
#[cfg(not(target_arch = "wasm32"))]
pub const SUPERNEO_PREPARED_DESTROY_SYMBOL: &[u8] = b"nightstream_gpu_superneo_prepared_destroy\0";
