...
def _format_u8_array(name: str, base: int, content: bytes, sha256_hex: str) -> str:
    lines = []
    lines.append("// @generated by crates/deprecated-neo-fold/riscv-tests/guests/rv32-smoke/export_rom_rs.py")
...
def main() -> int:
    ...
    out_rs = repo_root / "crates/deprecated-neo-fold/riscv-tests/binaries/rv32_smoke_rom.rs"
