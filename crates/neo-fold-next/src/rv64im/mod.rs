...
pub use kernel::{
    ...
    Rv64imProofProvePerf, Rv64imProofStatement, Rv64imProofWitnessBundle, Rv64imPublicProofVerifyPerf,
    Rv64imRoot0Claim, Rv64imStageClaimDigestBundle, Rv64imStageClaimProofBundle, Rv64imStageClaimSummaryProofBundle,
    ...
    Rv64imTraceProjectionBundle, Rv64imTraceProofBundle, Rv64imTraceShapeBundle, SelectedOpeningRef,
    SimpleKernelAuditOutput, SimpleKernelBuildPerf, SimpleKernelError, SimpleKernelKernelClaimBundle,
    SimpleKernelMainLaneArtifact, SimpleKernelMainLaneBinding, SimpleKernelOpeningBundle, SimpleKernelOpeningClaim,
    ...
    Stage1CanonicalRowBundle, Stage1ClaimSurface, Stage1OpeningPoints, Stage1PackagedOpeningProof,
    ...
    Stage3SelectedOpeningClaim, StageClaimBundleBuildPerf, StageDigestCommitment, StagePackageBundleBuildPerf,
    StagePackageBundleVerifyPerf, TranscriptArtifactSurface, TranscriptClaimSurface, TranscriptCursorSnapshot,
