...
pub use kernel::{
    ...
    build_rv64im_opening_convergence_proof_from_witnesses, build_signed_divrem_parity_case,
    ...
    control_flow_jal_manifest, control_flow_jalr_manifest, derive_phase0_point, derive_phase0_point_from_seed,
    domain_for_schema, encode_packed_column_evals_k, encode_words_to_field_evals_k, multiply_high_manifest,
    multiply_low_manifest, narrow_memory_load_manifest, narrow_memory_store_manifest, native_alu_focus_manifest,
    native_logic_compare_manifest, native_shift_manifest, native_upper_manifest, native_word_arith_manifest,
    native_word_shift_manifest, parity_source_cases, phase0_full_width_for_schema, phase0_point_seed,
    ...
    validate_rv64im_public_proof_against_input_with_perf, verify_claim_reduction_result_with_witnesses,
    verify_claim_reduction_results_with_witnesses, verify_packaged_simple_kernel,
    ...
    CommitmentContextId, CompactFinalOpeningTarget, EvalClaimError, ExactStageVectorBuildPerf, FamilyEvalClaim,
    ...
    QuadraticRoundPoly, RealAjtaiCommitmentVector, RealAjtaiCommitmentVectorPublic, ReducedEvalClaim,
    ...
    Rv64imAcceptedProofArtifact, Rv64imAcceptedProofClaim, Rv64imAcceptedProofMainLaneBinding,
    ...
    Rv64imParitySourceCase, Rv64imPreparedStepBridgeBinding, Rv64imProof, Rv64imProofInput, Rv64imProofProvePerf,
    Rv64imProofStatement, Rv64imProofWitnessBundle, Rv64imPublicProofOptions, Rv64imPublicProofVerifyPerf,
    Rv64imRoot0Claim, Rv64imStage1ExportProof, Rv64imStage2ExportProof, Rv64imStage3ExportProof,
