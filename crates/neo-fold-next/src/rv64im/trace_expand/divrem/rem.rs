...
pub(super) fn sequence(rs1_value: u64, rs2_value: u64, rs1: u8, rs2: u8, rd: u8) -> super::super::InlineTracePlan {
    let (effective_divisor, quotient, remainder, final_result) = divrem_signed64_values(rs1_value, rs2_value, true);
    ...
    asm.move_result(rd, v3, final_result);
    asm.finalize_inline()
}
