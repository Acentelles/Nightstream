//! Owns the Stage 2 Twist contract and the final linkage batch.
//! It does not own register- or RAM-local replay internals.
...
use crate::chip8::kernel::{
    expect_equal_k, expect_equal_k_slice, verify_sumcheck_known, KernelStepAux, SimpleKernelError, Stage2LinkClaims,
    Stage2TwistProof,
};
...
use self::ram::prove_ram_subsystem;
use self::reg::prove_register_subsystem;
