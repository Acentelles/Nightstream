...
private def checkProofImportWall : IO Bool := do
  let pattern := "^import TwistShout\\.(Checks|Generated|Regression|Golden)"
  let args := #[
    "-n",
    pattern,
    "TwistShout/Preliminaries.lean",
    "TwistShout/ShoutProtocol.lean",
    "TwistShout/TwistProtocol.lean",
    "TwistShout/Applications.lean"
  ]
