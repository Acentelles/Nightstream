...
- **Protocol role**: It fixes the canonical stage order, the exact family inventory per stage, and the public bridge view shape that the backend may consume.
...
- The public bridge view must be canonical; no compatibility-mode bit belongs here.
