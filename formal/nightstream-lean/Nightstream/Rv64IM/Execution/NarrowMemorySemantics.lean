...
/-!
Owns exact execution-level narrow-memory semantic facts above the canonical
...
structure NarrowMemoryExecutionFacts
...
def narrowMemoryExecutionFacts_of_opcodeClassFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  ...
  (classFacts :
    OpcodeClassExecutionFacts
      ...
      StateLocation
      proof) :
  NarrowMemoryExecutionFacts proof :=
  { classFacts := classFacts }

theorem frame_row_eq_at_index_of_narrowMemoryExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NarrowMemoryExecutionFacts proof)
  {idx : Nat}
...
theorem adjacentStates_of_narrowMemoryExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NarrowMemoryExecutionFacts proof)
  {idx : Nat}
...
theorem preparedStep_matches_row_of_narrowMemoryExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NarrowMemoryExecutionFacts proof)
  {idx : Nat}
...
theorem successor_matches_rows_of_narrowMemoryExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NarrowMemoryExecutionFacts proof)
  {idx : Nat}
...
theorem row_has_opcodeClass_at_index_of_narrowMemoryExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NarrowMemoryExecutionFacts proof)
  {idx : Nat}
...
noncomputable def narrowMemoryExecutionFacts_of_stepComposition
  ...
  narrowMemoryExecutionFacts_of_opcodeClassFacts
    (narrowMemoryFacts_of_stepComposition pkg)
