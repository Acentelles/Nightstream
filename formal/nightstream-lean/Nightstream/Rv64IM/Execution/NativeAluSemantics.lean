...
/-!
Owns exact execution-level native-ALU semantic facts above the canonical
...
structure NativeAluExecutionFacts
...
def nativeAluExecutionFacts_of_opcodeClassFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  ...
  (classFacts :
    OpcodeClassExecutionFacts
      ...
      StateLocation
      proof) :
  NativeAluExecutionFacts proof :=
  { classFacts := classFacts }

theorem frame_row_eq_at_index_of_nativeAluExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NativeAluExecutionFacts proof)
  {idx : Nat}
...
theorem adjacentStates_of_nativeAluExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NativeAluExecutionFacts proof)
  {idx : Nat}
...
theorem preparedStep_matches_row_of_nativeAluExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NativeAluExecutionFacts proof)
  {idx : Nat}
...
theorem successor_matches_rows_of_nativeAluExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NativeAluExecutionFacts proof)
  {idx : Nat}
...
theorem row_has_opcodeClass_at_index_of_nativeAluExecutionFacts
  {Pc BytecodeAddr RegIdx RamAddr Word StateLocation : Type _}
  {proof : OpcodeClassProof Pc BytecodeAddr RegIdx RamAddr Word StateLocation}
  (facts : NativeAluExecutionFacts proof)
  {idx : Nat}
  {row : ExpandedRow Pc BytecodeAddr RegIdx StateLocation}
  (hRow : proof.semantics.rows[idx]? = some row) :
  row.opcodeClass = .nativeAlu :=
  row_has_opcodeClass_at_index_of_opcodeClassExecutionFacts facts.classFacts hRow

noncomputable def nativeAluExecutionFacts_of_stepComposition
  ...
  nativeAluExecutionFacts_of_opcodeClassFacts
    (nativeAluFacts_of_stepComposition pkg)
